...
pub const VERTEX_DATA: [Vertex; 16] = [
    ...
    Vertex { pos: [-0.2,  0.6,  0.6, 1.0], color: [1.0, 1.0, 0.0, 1.0], }, // v1
    Vertex { pos: [-0.2, -0.2,  0.6, 1.0], color: [1.0, 1.0, 0.0, 1.0], }, // v2
    Vertex { pos: [ 0.6, -0.2,  0.6, 1.0], color: [1.0, 1.0, 0.0, 1.0], }, // v3
    Vertex { pos: [ 0.6, -0.2, -0.2, 1.0], color: [1.0, 1.0, 0.0, 1.0], }, // v4
    Vertex { pos: [ 0.6,  0.6, -0.2, 1.0], color: [1.0, 1.0, 0.0, 1.0], }, // v5
