...
impl RenderSubpass {
    ...
    pub(super) fn desc(&self) -> vk::SubpassDescription {
        ...
        vk::SubpassDescription {
            ...
            input_attachment_count    : self.inputs.len() as uint32_t,
            p_input_attachments       : self.inputs.as_ptr(),
            color_attachment_count    : self.colors.len() as uint32_t,
            ...
            preserve_attachment_count : self.preserves.len() as uint32_t,
