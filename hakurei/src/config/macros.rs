...
pub(crate) fn vk_string_to_format(raw: &String) -> Result<vk::Format, MappingError> {
...
pub(crate) fn vk_string_to_physical_feature(raw: &String) -> Result<PhysicalFeatureType, MappingError> {
