...
pub const PREFER_FIRSTLY_PRESENT_MODE  : vk::PresentModeKHR = vk::PresentModeKHR::Mailbox;
pub const PREFER_SECONDARY_PRESENT_MODE: vk::PresentModeKHR = vk::PresentModeKHR::Fifo;
