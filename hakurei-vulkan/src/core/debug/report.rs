...
impl HaDebugReport {
    ...
    pub fn setup(instance: &HaInstance, config: &DebugReportConfig) -> Result<HaDebugReport, ValidationError> {
...
impl DebugInstance for HaDebugReport {

    /// Some cleaning operations before this object was uninitialized.
    ///
    /// For HaDebugReport, it destroy the `vk::DebugReport` object.
    fn cleanup(&self) {
        unsafe {
