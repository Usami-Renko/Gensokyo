...
use resources::image::enums::{ Filter, SamplerMipmapMode, SamplerAddressMode, CompareOp, BorderColor };
...
impl HaSampler {
    ...
    pub fn new(device: &HaDevice, desc: &SamplerDescInfo) -> Result<HaSampler, ImageError> {
        ...
        let info = vk::SamplerCreateInfo {
            ...
            mipmap_mode   : desc.mipmap_mode.value(),
            address_mode_u: desc.address_u.value(),
            address_mode_v: desc.address_v.value(),
            address_mode_w: desc.address_w.value(),
            mip_lod_bias  : desc.mip_lod_bias,
            anisotropy_enable: desc.anisotropy_enable,
            max_anisotropy   : desc.max_anisotropy,
            compare_enable: desc.compare_enable,
            compare_op    : desc.compare_op.value(),
            min_lod: desc.min_lod,
            max_lod: desc.max_lod,
            border_color: desc.border_color.value(),
