...
use pipeline::shader::shaderc::options::HaShadercOptions;
use pipeline::shader::shaderc::options::{ HaShaderOptimalLevel, HaShaderDebugPattern };
...
impl VulkanShadercOptions {
    ...
    pub(super) fn to_shaderc_options(&self) -> HaShadercOptions {
